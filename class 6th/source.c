...
#pragma region scanf_s() 함수
	...
	//scanf_s("count 변수를 입력해주세요. %d", &count);

	//// 표준 입력 함수로 데이터를 입력하게 되면 버터에
	//// 데이터를 보관하였다가 입력하는 순간 버터 안의
	//// 내용을 프로그램에 전송합니다.
