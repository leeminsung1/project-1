...
#pragma region 변수
	...
	// 변수의 메모리공간은 프로그램이 실행될 때마다 바뀌며, 여러개의
	// 변수가 있을 때 서로 고유의 메모리 공간을 가지고 있습니다.

	/*data = 999;*/
	// 변수는 값이 계속 바뀔 수 있으며, 변수를 선언하고 해당하는 변수에
	// 값을 저장하려면 대입 연산자를 통해 값을 저장할 수 있습니다. (ctrl + k + c= 전체 주석) (ctrl + k + u = 전체 주석 해제)
#pragma endregion
#pragma region 변수의 이름 규칙
	...
	// 3. 번수의 경우 이미 중복된 변수의 이름을 허용하지 않지만,
...
#pragma region printf ( )  함수
	...
	//// 서식 지정자의 경우 하나의 표준 출력 하수에 여러 개의 서식을
