...
#pragma region 암묵적 형 변환
	...
	//printf("interger(정수형) + decimal(실수형) : % f", interger + decimal);
...
#pragma region 시프트 연산자
	...
	//printf("data변수를 왼쪽 2번 시프트 연산한 결과 : %d", data <<= 2); // 0010 1000 (40)
	//printf("data변수의 값 : %d\n", data); // 0010 1000 (40)
